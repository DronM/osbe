...
//try{
	...
	/* *********************** TOKEN AUTHORIZATION ********************* */
	$need_token = (defined('TOKEN_AUTH') && TOKEN_AUTH===TRUE);
	
	if (isset($_SESSION['LOGGED']) && $need_token){
	...
	&& !array_key_exists($_REQUEST[PARAM_METHOD],explode(',',TOKEN_AFTER_EXPIR_METHODS))
	){		
		//session_destroy();
		//$_SESSION = array();		
