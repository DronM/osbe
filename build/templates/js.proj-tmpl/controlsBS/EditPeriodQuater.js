...
/* constructor */
function EditPeriodQuater(id,options){
	options = options || {};
	...
	//from
	var d_opts = {};
	var dt = DateHandler.getStartOfDate(DateHandler.getFirstDateOfQuater(dy,dm));
	...
	//to
	var d_opts = {};
	var dt = DateHandler.getEndOfDate(DateHandler.getLastDateOfQuater(dy,dm));
	d_opts.value = DateHandler.dateToStr(dt,date_mask);
	...
	EditPeriodQuater.superclass.constructor.call(this,id,options);
}
