...
EditSelect.prototype.DEF_CLASS = "form-control";
EditSelect.prototype.DEF_CONT_CLASS = "form-group";
EditSelect.prototype.BTNS_CONTAINER_CLASS="input-group-btn";
...
EditSelect.prototype.toDOM = function(parent){	
	...
	if (this.m_label){
		...
		this.m_edit_container = new Control(null,"div",{"className":this.m_editContClassName});
