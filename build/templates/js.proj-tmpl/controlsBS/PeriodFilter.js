...
function PeriodFilter(id,options){
	...
	var self = this;	
	this.m_prevPeriod = new ButtonCtrl(id+"_prevperiod",
		{"glyph":"glyphicon-triangle-left",
		"attrs":{"title":this.m_prevPeriodTitle},
		"onClick":function(){
	...
	this.m_nextPeriod = new ButtonCtrl(id+"_nextperiod",
		{"glyph":"glyphicon-triangle-right",
		"attrs":{"title":this.m_nextPeriodTitle},
		"onClick":function(){
...
PeriodFilter.prototype.toDOM = function(parent){
	...
	function(event){
		var p = $(self.m_label.m_node);
		//var p = $(event.target);
		p.datepicker({
			format:options.datePattern,
			language:"ru",
