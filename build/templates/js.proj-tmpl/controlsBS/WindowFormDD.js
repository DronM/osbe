...
WindowFormDD.prototype.open = function(){
	...
	var self = this;
	if (this.m_view && !this.m_view.m_onSelect){		
		this.m_divWin.onCancel = function(){
			if (self.m_view.onCancel){
				self.m_view.onCancel();
			}
		};
	}
	//this.m_onCancel;
	...
	this.m_divWin.onclose = function(){
		//console.log("WindowFormDD.m_divWin.onclose view="+self.m_view);
