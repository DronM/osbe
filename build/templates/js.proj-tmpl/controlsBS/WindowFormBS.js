...
var OPENED_FORMS={};
/* constructor */
function WindowFormBS(options){
	options = options || {};	
	WindowFormBS.superclass.constructor.call(this,options);	
...
extend(WindowFormBS,WindowForm);

WindowFormBS.prototype.m_divWin;
WindowFormBS.prototype.m_divId;

WindowFormBS.prototype.getWindowForm = function(){
	return window;
}

WindowFormBS.prototype.open = function(){
...
WindowFormBS.prototype.close = function(){	
	//console.log("WindowFormBS.prototype.close");
	if (this.m_divWin){
...
WindowFormBS.prototype.getContentParent = function(){
	var n = DOMHandler.getElementsByAttr("drag-contentarea",nd(this.m_divId),"class");
	if (n && n.length){
		return n[0];
	}
}
WindowFormBS.prototype.setCaption = function(caption){
