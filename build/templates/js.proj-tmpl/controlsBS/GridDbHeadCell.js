...
function GridDbHeadCell(id,options){
	...
	this.getDbValue = options.getDbValue; 
...
GridDbHeadCell.prototype.getName = function(){
	if (this.m_readBind){
		return this.m_readBind.valueFieldId;
	}
	else{
		return GridDbHeadCell.superclass.getName.call(this);
	}
}
