...
function Edit(id,options){
	...
	*/
	...
	this.m_contClassName = options.contClassName;
	this.m_editContClassName = options.editContClassName;
}
extend(Edit,Control);
...
Edit.prototype.DEF_CLASS = "ctrlEdit";
Edit.prototype.BTN_SELECT_ID = "BtnSelect";
Edit.prototype.BTN_OPEN_ID = "BtnOpen";
Edit.prototype.BTN_CLEAR_ID = "BtnClear";
Edit.prototype.BTNS_CONTAINER_ID = "Btns";
Edit.prototype.BTNS_CONTAINER_CLASS="btns_cont";
Edit.prototype.INCORRECT_VAL_CLASS="incorrect_val";
Edit.prototype.DEF_CONT_CLASS = "edit_group_cont";
Edit.prototype.DEF_EDIT_CONT_CLASS = "edit_cont";
...
Edit.prototype.toDOM = function(parent){	
	...
	if (this.m_label){				
		this.m_container = new Control(null,(this.m_tableLayout)? "tr":"div",{"className":this.m_contClassName||this.DEF_CONT_CLASS});
		this.m_container.toDOM(parent);
		this.m_label.toDOM(this.m_container.m_node);
		this.m_edit_container = new Control(null,(this.m_tableLayout)? "td":"div",{"className":this.m_editContClassName||this.DEF_EDIT_CONT_CLASS});
