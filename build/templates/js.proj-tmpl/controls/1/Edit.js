...
Edit.prototype.toDOM = function(parent){	
	...
	if (this.m_label){		
		this.m_container = new Control(null,(this.m_tableLayout)? "tr":"div",{"className":this.DEF_CONT_CLASS});
		this.m_container.toDOM(parent);
		this.m_label.toDOM(this.m_container.m_node);
		this.m_edit_container = new Control(null,(this.m_tableLayout)? "td":"div",{"className":this.DEF_EDIT_CONT_CLASS});
