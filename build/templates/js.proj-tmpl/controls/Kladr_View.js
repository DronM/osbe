...
function Kladr_View(id,options){
	...
	this.addElement(this.m_ctrlRegion);
	...
	this.addElement(this.m_ctrlRaion);
	...
	this.addElement(this.m_ctrlNasPunkt);
	...
	this.addElement(this.m_ctrlGorod);
	...
	this.addElement(this.m_ctrlUlitza);
	...
	this.addElement(this.m_ctrlDom);
	...
	this.addElement(this.m_ctrlKorpus);
	...
	this.addElement(this.m_ctrlKvartira);
