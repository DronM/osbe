...
ViewInlineGridEdit.prototype.addDataControl = function(control,
	readBind,writeBind,options){
	var container = new ControlContainer(null,"td");
	container.setVisible(control.getVisible());
	container.setEnabled(control.getEnabled());
	this.setElementById("cont"+control.getId(),container);
